...
function Main() {
  ...
  useEffect(() => {
    const fetchUsers = async() => {
      ...
      const response = await axios.get(
        "https://endpoints.cervello.com.gh/users/getAllUsers",
        {
          headers: {
  ...
  return (
    <>
      <h2 className="intro-y text-lg font-medium mt-10">Manage Users</h2>
          ...
          <table className="table table-report -mt-2">
            <thead>
              <tr>
                ...
                <th className="text-center whitespace-nowrap">USERNAME</th>
                <th className="text-center whitespace-nowrap">ROLE</th>
                <th className="text-center whitespace-nowrap">PHONE NUMBER</th>
            ...
            <tbody>
              {users.map(({firstName, lastName, username, role, phoneNumber, email,organizationName}) => (
